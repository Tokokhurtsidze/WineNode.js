...
const translations = {
  GE: {
    ...
    stats: [{ l: 'დაარსდა', v: '2021' }, { l: 'სახეობა', v: '5' }, { l: 'ლოკაცია', v: 'ყვარელი' }, { l: 'ხარისხი', v: 'პრემიუმი' }] as Stat[],
  ...
  EN: {
    ...
    stats: [{ l: 'Founded', v: '2021' }, { l: 'Varieties', v: '5' }, { l: 'Location', v: 'Kvareli' }, { l: 'Quality', v: 'Premium' }] as Stat[],
  ...
  RU: {
    ...
    p2: 'Наша коллекция включает пять знаковых сортов: Ркацители, Саперави, Киндзмараули и Алазанская Долина (белое/красное). Каждая бутылка — это результат уникального террóуара Кварели и сплоченной работы нашей команды.',
    quote: '"Наша миссия — познакомить мир с аутентичным вкусом земли Кварели и премиальным стандартом грузинского виноделия."',
    stats: [{ l: 'Основано', v: '2021' }, { l: 'Видов', v: '5' }, { l: 'Локация', v: 'Кварели' }, { l: 'Качество', v: 'Премиум' }] as Stat[],
    ...
    <div className="min-h-screen bg-white dark:bg-[#0B0E14] text-[#1a1a1a] dark:text-gray-200 font-serif transition-colors duration-300">
      ...
      <section className="relative pt-32 pb-20 px-6 max-w-[1200px] mx-auto overflow-hidden">
        <div className="flex flex-col items-center mb-16">
          <span className="text-[10px] uppercase tracking-[0.5em] text-[#5b1f1f] font-bold mb-4 animate-fadeIn">
            {t.badge}
          </span>
          <h1
            className="text-5xl md:text-7xl font-light text-[#1a1a1a] tracking-tighter text-center"
            dangerouslySetInnerHTML={{ __html: t.title }}
          />
          <div className="w-12 h-[1px] bg-[#5b1f1f]/30 mt-8" />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="relative group overflow-hidden rounded-sm animate-fadeInLeft">
            <div className="absolute inset-0 bg-[#5b1f1f]/5 group-hover:bg-transparent transition-colors duration-700 z-10" />
            <img
              src="https://cdn.pixabay.com/photo/2019/08/13/09/37/village-4402925_640.png"
              alt="Vineyard"
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed text-lg animate-fadeInRight">
            <p className="first-letter:text-5xl first-letter:text-[#5b1f1f] first-letter:font-bold first-letter:mr-3 first-letter:float-left">
              {t.p1}
            </p>
            <p>{t.p2}</p>
