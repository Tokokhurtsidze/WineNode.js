...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Save order data to localStorage — CheckoutSuccessPage reads it after redirect
    localStorage.setItem('lamiani-pending-order', JSON.stringify({
      userId: user.uid,
          ...
          >
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400 dark:text-[#555]">Redirecting to secure payment...</p>
              </div>
          ...
          <div>
            <div className="rounded-2xl border border-gray-100 dark:border-[#B89968]/15 bg-white/80 dark:bg-[#12151D]/80 backdrop-blur-sm p-6 sticky top-28" style={{ boxShadow: '0 24px 60px rgba(0,0,0,0.08)' }}>
              ...
              <div className="flex items-center gap-2 mb-4 p-3 bg-gray-50 dark:bg-[#0B0E14]/40 rounded-xl border border-gray-100 dark:border-[#B89968]/10">
                ...
                <span className="text-[10px] text-gray-400 dark:text-[#555]">Secure payment via Dodo Payments</span>
              </div>
              ...
              <button
                ...
                form="checkout-form"
                disabled={loading}
                className="w-full py-3.5 bg-[#5b1f1f] text-white text-xs font-bold uppercase tracking-widest rounded-xl hover:bg-[#6e2626] transition-all duration-300 shadow-lg shadow-[#5b1f1f]/20 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                <Lock size={12} />
